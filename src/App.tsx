...
import { GlobalContext, GlobalContextOptional, initialContextState } from './Utils/Context/GlobalContext'
        ...
        <GlobalContext.Provider value={{ ...context, updateGlobalContext }}>
            ...
            <Router>
                <Container>
                    ...
                    <Route type="authenticated" exact path="/api" component={BackendTodo} />
                    <Route type="authenticated" path="/api/:id" component={oneTodo} />
                    <Route type="authenticated" path="/share/:id/:title" component={Share} />
